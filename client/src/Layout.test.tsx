...
describe('Layout', () => {
  it('shows the Expenses tab by default, with the others hidden', () => {
  ...
  it('switches to the Budgets tab and back without unmounting either panel', () => {
    render(<Layout onLogout={vi.fn()} />)
    ...
    expect(screen.getByRole('button', { name: 'Expenses' })).not.toHaveAttribute('aria-current')
